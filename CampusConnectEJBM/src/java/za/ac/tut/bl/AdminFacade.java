...
public class AdminFacade extends AbstractFacade<Admin> implements AdminFacadeLocal {
    ...
    @Override
    public List<SupportRequest> findReguestsForSpecificStudent(String studentNumber) {
        Query query = em.createQuery("SELECT s FROM SupportRequest s WHERE s.student.studentNumber = :studentNumber");
