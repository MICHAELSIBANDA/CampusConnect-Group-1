    ...
    <div class="dashboard-container container">
        <div class="dashboard-card">
            ...
            <div class="top-bar">
                <h4>CampusConnect</h4>
                <div>
                    <a href="${pageContext.request.contextPath}/DashboardServlet" class="btn btn-sm btn-outline-light me-2">
                        <i class="fas fa-home me-1"></i> Dashboard
                    </a>
                    <a href="${pageContext.request.contextPath}/LogoutServlet" class="btn btn-sm btn-danger">
                            ...
                            <c:when test="${not empty requestScope.userRequests}">
                                <c:forEach items="${requestScope.userRequests}" var="request">
                                    <tr data-status="${request.status}">
                                        ...
                                        <td>
                                            <button class="action-btn view-details" data-id="${request.id}">
