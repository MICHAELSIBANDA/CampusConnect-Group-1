...
<div class="admin-card">
    ...
    <div class="mb-5">
        ...
        <div class="nav-pills-custom">
            ...
            <!-- View Requests -->
            <a href="viewRequestsServelt.do" class="nav-pill-item">
            ...
            <a href="createEvent.jsp" class="nav-pill-item">
                <i class="fa-solid fa-calendar-days"></i> Create Event
            </a>
            ...
            <!-- Logout -->
            <a href="login.jsp" class="nav-pill-item">
